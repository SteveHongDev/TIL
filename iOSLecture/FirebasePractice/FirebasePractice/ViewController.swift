...
extension ViewController {
    func saveBasicTypes() {
        ...
        db.child("str").setValue("string value - hi Firebase")
    ...
    func saveCustomers() {
        ...
        let books = [Book(title: "Charlotte's Web", author: "Someone"), Book(title: "Beyond Order", author: "Jordan B. Peterson")]
        
        let customer1 = Customer(id: "\(Customer.id)", name: "Gen", books: books)
        Customer.id += 1
        let customer2 = Customer(id: "\(Customer.id)", name: "Fujihara", books: books)
        Customer.id += 1
        let customer3 = Customer(id: "\(Customer.id)", name: "Aimyon", books: books)
        Customer.id += 1
...
//        db.child("str").setValue("string value - hi Firebase")
        ...
        db.updateChildValues(["str": "Update Completed"])
...
struct Customer: Codable {
    ...
    var toDictionary: [String: Any] {
        let booksArray = books.map { book in
            book.toDictionary
        }
